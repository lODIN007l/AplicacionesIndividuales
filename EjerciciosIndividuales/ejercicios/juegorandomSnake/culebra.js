...
let DIRECCIONES = {
  ...
  let CONTENEDOR_JUEGO = document.getElementById("contenedorJuegoApli");
  ...
  function gameOver() {
    clearInterval(ciclo);
    ciclo = undefined;
    dibujarTexto(CTX, "Ha perdido", 300, 260);
    dibujarTexto(CTX, "Click para volver a jugar", 300, 310);
    CONTENEDOR_JUEGO.classList.add(CSS_CLASE_SACUDIR_HORIZONTALMENTE);
  }
  ...
  function empezarJuego() {
    ...
    CONTENEDOR_JUEGO.classList.remove(CSS_CLASE_SACUDIR_HORIZONTALMENTE);
  ...
  dibujarTexto(CTX, "↑ ↓ → ←", 300, 310);
  dibujarTexto(CTX, "", 300, 360);
